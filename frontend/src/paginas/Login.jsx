...
const Login = () => {
    return ( 
        <>        
            <h1 className="text-teal-500 font-black text-6xl capitalize">Inicia sesión y administra la lista de tu {''}
                <span className="text-teal-700"> bebé</span>
            </h1>    
            <form className="my-10 bg-white shadow rounded-lg p-10">
                <div className="my-5">
                    <label className="uppercase text-teal-700 block text-xl font-bold"
                           htmlFor="email"
                        >Email</label>
                        <input
                            id="email"
